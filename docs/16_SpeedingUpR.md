...
##  sqrt(x)  2.48  2.53  3.18   2.75  3.03 12.3   100  a 
##  x^(0.5) 24.90 25.07 26.93  25.37 25.89 54.0   100   b
```
...
## Unit: milliseconds
##               expr  min   lq mean median   uq  max neval cld
##           f1(data) 3.26 3.70 4.37   3.98 4.46 12.7   100   a
##  f2.noReturn(data) 3.21 3.67 4.69   4.01 4.92 17.8   100   a
```
...
## Unit: milliseconds
##                  expr  min   lq mean median   uq  max neval cld
##              f1(data) 3.32 3.51 3.78   3.66 3.83 7.01   100  a 
##  f3.AllocOutput(data) 3.34 3.55 4.01   3.73 4.06 8.31   100   b
```
...
## Unit: microseconds
##            expr  min   lq mean median   uq  max neval cld
##        f1(data) 3189 3609 3949   3784 4203 8009   100   b
##  f4.apply(data)  271  320  411    339  372 4446   100  a
```
...
## Unit: microseconds
##            expr min  lq mean median  uq  max neval cld
##  f4.apply(data) 280 299  327    314 327  577   100  a 
##  f5.dplyr(data) 431 446  568    471 527 4310   100   b
```
...
## Unit: microseconds
##            expr   min    lq  mean median    uq   max neval cld
##  f4.apply(data) 23554 25373 28666  26759 30013 53507   100   b
##  f5.dplyr(data)   593   661   921    864   974  5624   100  a
```
...
## Unit: milliseconds
##            expr   min     lq  mean median     uq    max neval cld
##  f4.apply(data) 281.0 307.57 413.7 392.49 488.15 706.15   100   b
##  f5.dplyr(data)   1.9   2.24   2.5   2.39   2.62   4.66   100  a
```
...
<img src="16_SpeedingUpR_files/figure-html/unnamed-chunk-16-1.png" width="672" />
...
## Unit: milliseconds
##                                 expr min  lq mean median  uq max neval cld
##      boot.for(Volume ~ Girth, trees) 115 131  159    167 178 212   100  a 
##  boot.foreach(Volume ~ Girth, trees) 160 184  203    195 224 293   100   b
```
...
##      boot.for(Volume ~ Girth, massiveTrees) 1013 1168 1206   1230 1274
##  boot.foreach(Volume ~ Girth, massiveTrees)  635  650  755    658  698
##   max neval cld
##  1416   100   b
##  1179   100  a
```
...
## Unit: milliseconds
##      expr min  lq mean median  uq  max neval cld
##    serial 601 679  753    721 809 1171   100   b
##  parallel 541 607  649    628 653 1297   100  a
```
...
##  1.07 1.13 1.23   1.18 1.30 1.90   100   a
##  1.14 1.19 1.25   1.21 1.27 1.74   100   a
```
