...
##  sqrt(x)  2.31  2.38  2.57   2.43  2.51  8.74   100  a 
##  x^(0.5) 23.88 23.96 24.16  24.00 24.05 37.89   100   b
```
...
## Unit: milliseconds
##               expr  min   lq mean median   uq   max neval cld
##           f1(data) 3.32 3.69 4.46   4.15 4.55 11.77   100   a
##  f2.noReturn(data) 3.33 3.59 4.52   4.05 4.81  9.86   100   a
```
...
## Unit: milliseconds
##                  expr  min   lq mean median   uq   max neval cld
##              f1(data) 3.33 3.54 3.97   3.77 4.15  7.88   100   a
##  f3.AllocOutput(data) 3.35 3.60 4.20   4.00 4.37 11.48   100   a
```
...
## Unit: microseconds
##            expr  min   lq mean median   uq  max neval cld
##        f1(data) 3317 3613 4032   3864 4182 8699   100   b
##  f4.apply(data)  277  315  388    348  381 2893   100  a
```
...
## Unit: microseconds
##            expr min  lq mean median  uq  max neval cld
##  f4.apply(data) 271 303  334    325 363  516   100  a 
##  f5.dplyr(data) 490 511  706    558 646 7363   100   b
```
...
## Unit: microseconds
##            expr   min    lq  mean median    uq   max neval cld
##  f4.apply(data) 23577 26431 30099  28196 33003 53513   100   b
##  f5.dplyr(data)   734   967  1176   1075  1244  6357   100  a
```
...
## Unit: milliseconds
##            expr    min     lq   mean median     uq   max neval cld
##  f4.apply(data) 283.72 324.40 446.14 424.73 514.17 752.6   100   b
##  f5.dplyr(data)   2.36   2.76   3.26   2.92   3.23   9.9   100  a
```
...
<img src="21_SpeedingUpR_files/figure-html/unnamed-chunk-16-1.png" width="672" />
...
## Unit: milliseconds
##                                 expr min  lq mean median  uq max neval cld
##      boot.for(Volume ~ Girth, trees) 110 134  169    151 186 422   100  a 
##  boot.foreach(Volume ~ Girth, trees) 164 180  236    204 264 434   100   b
```
...
##      boot.for(Volume ~ Girth, massiveTrees) 1231 1439 1575   1527 1716
##  boot.foreach(Volume ~ Girth, massiveTrees)  718  793 1000    895 1195
##   max neval cld
##  2470   100   b
##  1829   100  a
```
...
## Unit: milliseconds
##      expr min  lq mean median  uq  max neval cld
##    serial 605 628  705    696 733 1103   100   b
##  parallel 541 583  634    618 637 1020   100  a
```
...
##  1.16 1.18 1.24   1.19 1.24 1.54   100  a 
##  1.22 1.23 1.27   1.24 1.27 1.64   100   b
```
