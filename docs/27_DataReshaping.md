...
## 1 A              287. <NA>         NA      NA        NA
## 2 A              315. <NA>         NA      NA        NA
## 3 B              220. Lake Elaine   6.5    40         8
## 4 B              271. Lake Elaine   6.5    40         8
## 5 C              227. Mormon Lake   6.3   210        10
## 6 C              245. Mormon Lake   6.3   210        10
...
##   Lake_ID Fish.Weight Lake_Name      pH  area avg_depth
##   <chr>         <dbl> <chr>       <dbl> <dbl>     <dbl>
## 1 B              220. Lake Elaine   6.5    40         8
## 2 B              271. Lake Elaine   6.5    40         8
## 3 C              227. Mormon Lake   6.3   210        10
## 4 C              245. Mormon Lake   6.3   210        10
```
